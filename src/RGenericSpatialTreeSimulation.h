 ...
 */
#ifndef RCOALESCENCE_R_GENERIC_SPATIAL_TREE_H
#define RCOALESCENCE_R_GENERIC_SPATIAL_TREE_H
...
namespace rcoalescence
{
     ...
     */
    template<class T>
    class RGenericSpatialTreeSimulation : public virtual RTreeSimulation, public virtual T
    {
    protected:
    ...
    public:
        ...
        RGenericSpatialTreeSimulation<T>()
        {
            output_database = "not_set";
            setLoggingMode(false);
        }

        ~RGenericSpatialTreeSimulation<T>() override  = default;
...
#endif //RCOALESCENCE_R_GENERIC_SPATIAL_TREE_H
