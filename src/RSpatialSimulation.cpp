...
RSpatialTreeSimulation::RSpatialSimulation() : RTreeSimulation(), SpatialTree()
{
...
RSpatialTreeSimulation::~RSpatialSimulation()
= default;


void RSpatialTreeSimulation::setDispersalParameters(const double &sigma_in, const string &dispersal_method_in, const double &tau_in,
