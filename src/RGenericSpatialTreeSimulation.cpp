...
RGenericSpatialTreeSimulation::RGenericSpatialTreeSimulation() : RTreeSimulation(), SpatialTree()
{
    output_database = "not_set";
    setLoggingMode(false);
}

RGenericSpatialTreeSimulation::~RGenericSpatialTreeSimulation() = default;

void RGenericSpatialTreeSimulation::setDispersalParameters(const double &sigma_in,
...
void RGenericSpatialTreeSimulation::setHistoricalMapParameters(const string &historical_fine_file_map_in,
...
void RGenericSpatialTreeSimulation::addHistoricalMap(const string &fine_map,
                                              const string &coarse_map,
                                              const double &time,
                                              const double &rate)
{
...
void RGenericSpatialTreeSimulation::setMapParameters(const string &fine_map_file_in,
...
void RGenericSpatialTreeSimulation::setupR()
{
    if(!paths_fine.empty())
    {
...
bool RGenericSpatialTreeSimulation::runSimulation()
{
    if(!paths_fine.empty())
    {
        sim_parameters->setHistoricalMapParameters(paths_fine,
