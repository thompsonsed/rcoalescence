...
void SpatialTree::parseArgs(vector<string> &comargs)
{
    ...
    if(comargs[1] == "-h" || comargs[1] == "-H" || argc == 1 || comargs[1] == "-help" || comargs[1] == "-e")
    {
        ...
        os << "2: the simulation job_type (for file reference)." << endl;
        ...
        {
            os << "1: the number used for setting the seed." << endl;
            ...
            os << "22: job_type - for referencing the specific job_type later on." << endl;
    ...
    if(comargs[1] == "-r" || comargs[1] == "-R" || comargs[1] == "-resume")
    {
        ...
        {
            stringstream ss;
            ss << "Incorrect number of current_metacommunity_parameters provided for resuming simulation. Expecting:"
               << endl;
            ss << "1: -r flag" << endl;
            ss << "2: the folder containing the paused simulation (should hold a 'Pause' folder)" << endl;
            ss << "3: the simulation seed" << endl;
            ss << "4: the simulation job_type" << endl;
