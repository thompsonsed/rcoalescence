 ...
 */
    ...
    public:
        ...
        RSpatialTreeSimulation() : RTreeSimulation(), SpatialTree(), paths_fine(), numbers_fine(), rates_fine(),
                                   times_fine(), paths_coarse(), numbers_coarse(), rates_coarse(), times_coarse()
        {
            output_database = "not_set";
            setLoggingMode(false);
        }

        ~RSpatialTreeSimulation() override = default;
